...
class NameSex{    
     ...
     public static function isName($name){
         if(!preg_match('/^([\xe4-\xe9][\x80-\xbf]{2}){2,4}$/',$name))  return false;      
          //var_dump(self::$arrXing); die;         
         $name = self::mbstringToArray($name);   
         $newname = isset($name[0]) ? $name[0] : '';        
         if( in_array( $newname,self::$arrXing)  ) {
             return true;   
         }
         $newname = isset($name[1]) ? $name[0].$name[1] : '';
         if( in_array( $newname,self::$arrXing)  ) {
             return true;   
         }
         return false;         
    ...
    private static function mbstringToArray($str,$charset="utf-8") {
